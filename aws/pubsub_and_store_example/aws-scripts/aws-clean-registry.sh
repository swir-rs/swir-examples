...
aws ecr delete-repository --repository-name swir-example-pubsub-aws-configurator --force

docker rmi ${repoUri}/swir/swir-example-pubsub-java-source:v0.3.2
docker rmi ${repoUri}/swir/swir-example-pubsub-java-processor:v0.3.2
docker rmi ${repoUri}/swir/swir-example-pubsub-python-sink:v0.3.2
docker rmi ${repoUri}/swir/swir-example-pubsub-python-processor:v0.3.2
docker rmi ${repoUri}/swir/swir:v0.3.2
docker rmi ${repoUri}/swir-example-pubsub-aws-configurator:v0.3.2
